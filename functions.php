...
function my_enqueue_scripts()
{
    ...
    wp_enqueue_script('main_js', $uri . '/js/main.js', array());
...
function get_eyecatch_with_default()
{
    if (has_post_thumbnail()) :
        ...
        $img = array(get_template_directory_uri() . '/images/news@2x.png');
    endif;
...
function get_eyecatch_with_default_lg()
{
    if (has_post_thumbnail()) :
        ...
        $img = array(get_template_directory_uri() . '/images/dummy-590X370.png');
    endif;
...
function get_eyecatch_with_default_sm()
{
    if (has_post_thumbnail()) :
        ...
        $img = array(get_template_directory_uri() . '/images/dummy.png');
    endif;
...
function bcn_add($bcnObj){
    if (is_singular('post')&&!is_post_type_archive()){
        $bcnObj->add(new bcn_breadcrumb('ブログ', null,
